                    ...
                    return (
                        ...
                        (!(n("no-color") || n("no-colors") || n("color=false")) &&
                            (!!(n("color") || n("colors") || n("color=true") || n("color=always")) ||
                                (!(r.stdout && !r.stdout.isTTY) && ("win32" === r.platform || "COLORTERM" in r.env || ("dumb" !== r.env.TERM && !!/^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test(r.env.TERM))))))
                    );
                })();
            }.call(r, t(8)));
        },
                        ...
                        i(e, [
                            {
                                key: "afterEach",
                                value: function (e, r) {
                                    if (("function" == typeof e ? ((r = e), (e = "all")) : "string" == typeof e && (e = "all" === e ? this.phases.slice() : [e]), "function" != typeof r))
